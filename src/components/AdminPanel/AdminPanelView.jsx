  ...
  return (
    ...
    >
      ...
      <div className="bg-[#191820] rounded-xl border border-white/[0.08] overflow-hidden">
        <div className="px-6 py-5 border-b border-white/[0.06] flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div>
            <p className="text-[15px] font-semibold text-white/75">User Management</p>
            <p className="text-[12px] text-white/30 mt-0.5">{users.length} accounts total</p>
          </div>
          <div className="flex items-center gap-2">
            <input
              ...
              className="bg-white/[0.05] border border-white/[0.08] rounded-lg px-3 py-2 text-[13px] text-white/65 placeholder-white/20 outline-none focus:border-white/20 focus:bg-white/[0.08] transition-all w-full sm:w-56"
            />
            <motion.button
              ...
              transition={{ duration: 0.15 }}
              className={`flex-shrink-0 text-[12px] font-semibold border rounded-lg px-4 py-2 cursor-pointer transition-all whitespace-nowrap ${
                showAddForm
            ...
            <thead>
              <tr className="border-b border-white/[0.06]">
                {["User", "Email", "Role", "Actions"].map((h) => (
                  <th key={h} className="text-left px-6 py-4 text-[11px] font-semibold tracking-widest uppercase text-white/25">{h}</th>
                ))}
              </tr>
            </thead>
            <tbody>
                  ...
                  >
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        <div className="w-9 h-9 rounded-full bg-white/[0.07] border border-white/[0.08] flex items-center justify-center flex-shrink-0">
                          <span className="text-[13px] font-semibold text-white/45">{u.name[0]}</span>
                        </div>
                        <span className="text-[14px] font-medium text-white/75">{u.name}</span>
                      </div>
                    </td>
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="text-[12px] font-medium text-white/40 hover:text-white/70 transition-colors cursor-pointer border border-white/[0.09] rounded-lg px-3 py-1.5 hover:border-white/20"
                        >
                          Edit
                        </button>
                        <button
                          onClick={() => handleDelete(u.id)}
                          className="text-[12px] font-medium text-red-400/50 hover:text-red-400/90 transition-colors cursor-pointer border border-red-500/10 rounded-lg px-3 py-1.5 hover:border-red-500/25"
                        >
                          Delete
                        </button>
                      </div>
